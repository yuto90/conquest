...
- 状態: 2026-08-16設計。下記4件は2026-08-16に承認済み
...
2026-08-16に4件とも提案どおり承認した。本文の操作・UIはこの確定値である。

| # | 判断 | 確定 |
| --- | --- | --- |
| 1 | 2人対戦の出兵操作 | 自軍島から目標へドラッグする。通常CPU戦の2タップは維持する |
| 2 | 画面の向き | 同じ向きの1画面。2P HUDは回転しない |
| 3 | モード名 | 英語 `2P LOCAL`、日本語 `2人対戦` |
| 4 | 一時停止 | 既存の右上ボタンを共有する |
